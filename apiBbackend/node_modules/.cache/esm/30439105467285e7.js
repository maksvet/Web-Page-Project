let express,uuidv4,util,fs,path,jwt,bcrypt,badRequest,objProps,objUserProps,message,validateItem,validateUser,validateString,validateEmail,validatePhone,validatePswd,returnMessage,authToken;_467‍.x([["default",()=>_467‍.o]]);_467‍.w("express",[["default",["express"],function(v){express=v}]]);_467‍.w("uuid",[["v4",["uuidv4"],function(v){uuidv4=v}]]);_467‍.w("util",[["default",["util"],function(v){util=v}]]);_467‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_467‍.w("path",[["default",["path"],function(v){path=v}]]);_467‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_467‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_467‍.w("./helpFns.js",[["badRequest",["badRequest"],function(v){badRequest=v}],["objProps",["objProps"],function(v){objProps=v}],["objUserProps",["objUserProps"],function(v){objUserProps=v}],["message",["message"],function(v){message=v}],["validateItem",["validateItem"],function(v){validateItem=v}],["validateUser",["validateUser"],function(v){validateUser=v}],["validateString",["validateString"],function(v){validateString=v}],["validateEmail",["validateEmail"],function(v){validateEmail=v}],["validatePhone",["validatePhone"],function(v){validatePhone=v}],["validatePswd",["validatePswd"],function(v){validatePswd=v}],["returnMessage",["returnMessage"],function(v){returnMessage=v}],["authToken",["authToken"],function(v){authToken=v}]]);
...
router.post('/users', validateUser, validateString, validatePswd, validateEmail, returnMessage, async (req, res) => {
    ...
    req.body.password = bcrypt.hashSync(req.body.password, 10)
    _467‍.g.console.log(req.body.password)
    users.push(req.body)
